    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('WaitingTimeTo', models.CharField(blank=True, max_length=50)),
                ...
                ('WaitingTimeFrom', models.CharField(blank=True, max_length=50)),
                ...
                ('TourCurrency', models.CharField(max_length=200)),
                ('TourTime', models.CharField(max_length=200)),
